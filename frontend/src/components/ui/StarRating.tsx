...
export default function StarRating({
    ...
    return (
        <div className={`d-flex align-items-center gap-1 ${className}`} style={{ display: 'inline-flex', gap: 2 }}>
            {stars.map((star) => {
                ...
                return (
                    <svg
                        ...
                        height={size}
                        viewBox="0 0 24 24"
                        fill={filled ? '#FD4621' : 'none'}
                        stroke={filled ? '#FD4621' : '#ccc'}
                        strokeWidth="1.5"
                        strokeLinecap="round"
